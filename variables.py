...
hvardict = {
    ...
    'tau_dxy': {'var': 'tau_dxy', 'nbin': 50, 'min': 0., 'max': 0.05, 'title': 'tau_dxy', 'sel': 'tau_genpt>0&&tau_pt>0'},
    'tau_dxy_err': {'var': 'tau_dxy_err', 'nbin': 40, 'min': 0., 'max': 0.01, 'title': 'tau_dxy_err', 'sel': 'tau_genpt>0&&tau_pt>0'},
    'tau_dxy_sig': {'var': 'tau_dxy_sig', 'nbin': 25, 'min': 0., 'max': 15, 'title': 'tau_dxy_sig', 'sel': 'tau_genpt>0&&tau_pt>0'},
    
    'tau_eta': {'var': 'tau_eta', 'nbin': 12, 'min': -2.4, 'max': 2.4, 'title': 'eta', 'sel': 'tau_genpt>0&&tau_pt>0'},

    'tau_flightLength': {'var': 'tau_flightLength', 'nbin': 50, 'min': 0., 'max': 1, 'title': 'tau_flightLength', 'sel': 'tau_genpt>0&&tau_pt>0&&tau_flightLength>=0'},
    'tau_flightLength_sig': {'var': 'tau_flightLength_sig', 'nbin': 25, 'min': 0., 'max': 8, 'title': 'tau_flightLength_sig', 'sel': 'tau_genpt>0&&tau_pt>0&&tau_flightLength>=0'},

    'tau_ip3d': {'var': 'tau_ip3d', 'nbin': 50, 'min': 0., 'max': 0.05, 'title': 'tau_ipd3', 'sel': 'tau_genpt>0&&tau_pt>0'},
    'tau_ip3d_err': {'var': 'tau_ip3d_err', 'nbin': 40, 'min': 0., 'max': 0.01, 'title': 'tau_ip3d_err', 'sel': 'tau_genpt>0&&tau_pt>0'},
    'tau_ip3d_sig': {'var': 'tau_ip3d_sig', 'nbin': 25, 'min': 0., 'max': 10, 'title': 'tau_ip3d_sig', 'sel': 'tau_genpt>0&&tau_pt>0'},
    ...
    # v2p1 discriminators
    'tau_byDeepTau2017v2p1VSjetraw':{'var': 'tau_byDeepTau2017v2p1VSjetraw', 'nbin':20, 'min':0., 'max' : 1, 'title': 'Raw DeepTauv2p1 vs jets', 'sel': 'tau_pt>0'},
    'tau_byDeepTau2017v2p1VSmuraw':{'var': 'tau_byDeepTau2017v2p1VSmuraw', 'nbin':20, 'min':0., 'max' : 1, 'title': 'Raw DeepTauv2p1 vs muons', 'sel': 'tau_pt>0'},
    'tau_byDeepTau2017v2p1VSeraw':{'var': 'tau_byDeepTau2017v2p1VSeraw', 'nbin':20, 'min':0., 'max' : 1, 'title': 'Raw DeepTauv2p1 vs electrons', 'sel': 'tau_pt>0'},
