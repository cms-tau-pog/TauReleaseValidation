...
if RelVal == '9_3_0_pre4':
    if runtype == 'ZTT':
        print 'ZTT'
        dir = 'root://eoscms//eos/cms/store/relval/CMSSW_9_3_0_pre4/RelValZTT_13/MINIAODSIM/PU25ns_93X_mc2017_realistic_v1-v1/00000/'
        filelist.append(dir+'048BC8C0-9487-E711-B1BC-0CC47A4D76B6.root')
        filelist.append(dir+'5680C1C1-9487-E711-8224-0CC47A78A45A.root')
    elif runtype == 'ZMM':
        print 'ZMM'
    elif runtype == 'QCD':
        print 'QCD Pt_hat 15-3000GeV, flat'
        dir = 'root://eoscms//eos/cms/store/relval/CMSSW_9_3_0_pre4/RelValQCD_FlatPt_15_3000HS_13/MINIAODSIM/PU25ns_93X_mc2017_realistic_v1-v1/00000/'
        filelist.append(dir+'580AE5E7-6487-E711-823F-0CC47A4D7692.root')
        filelist.append(dir+'A03B83E9-6487-E711-A834-0025905A613C.root')
    elif runtype == 'TTbar' or runtype == 'TTbarTau':
        print 'TTbar'
        dir = 'root://eoscms//eos/cms/store/relval/CMSSW_9_3_0_pre4/RelValTTbar_13/MINIAODSIM/PU25ns_93X_mc2017_realistic_v1-v1/00000/'
        filelist.append(dir+'4E66A27F-8687-E711-8804-0CC47A4D7606.root')
        filelist.append(dir+'EA21F381-8687-E711-96A3-0CC47A78A2F6.root')

if RelVal == '9_2_8_default':
    if runtype == 'ZTT':
        maxEvents = -1  # long(3*9000./(0.64*0.64)+0.5)
        print 'ZLL', maxEvents
        dir = 'root://cms-xrd-global.cern.ch//store/mc/RunIISummer17MiniAOD/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/92X_upgrade2017_realistic_v10_ext1-v2/10000/'
        filelist.append(dir+'00F9D855-E293-E711-B625-02163E014200.root')
if RelVal == '9_2_8_ZSfix':
    if runtype == 'ZTT':
        maxEvents = -1  # long(3*9000./(0.64*0.64)+0.5)
        print 'ZLL', maxEvents
        dir = 'root://cms-xrd-global.cern.ch//store/mc/RunIISummer17MiniAOD/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/92X_upgrade2017_realistic_Candidate_forECALStudies_ext1-v1/70000/'
        filelist.append(dir+'00F78DA3-E0A3-E711-B32C-A0369FC5D2A8.root')
